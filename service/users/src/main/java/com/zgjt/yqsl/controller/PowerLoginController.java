...
public class PowerLoginController {
    ...
    * */
    ...
    public ResponseApi loginOut(HttpServletRequest request){
        powerLoginService.LoginOut(request);
    ...
    public ResponseApi getUserInfo(HttpServletRequest request){
        return  ResponseApi.sucess().data(powerLoginService.getCacheUser(request));
    }
}
