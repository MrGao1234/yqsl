...
public class ImageCodeUtil {
    ...
    private static BufferedImage createImage(String content, String imgPath, boolean needCompress) throws Exception {
        ...
        // 插入图片
        ImageCodeUtil.insertImage(image, imgPath, needCompress);
        return image;
    }
    ...
    public static String encode(String content, String destPath, boolean needCompress) throws Exception {
        return ImageCodeUtil.encode(content, null, destPath, needCompress);
    }
    ...
    public static String encode(String content, String destPath) throws Exception {
        return ImageCodeUtil.encode(content, null, destPath, false);
    }
    ...
    public static void encode(String content, OutputStream output) throws Exception {
        ImageCodeUtil.encode(content, null, output, false);
    }
